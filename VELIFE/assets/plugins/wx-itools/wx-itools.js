...
let wxItools = {
   ...
   * @baseUrl {String} 接口地址
   * */
  request(baseUrl, methods, datas, callback) {
          ...
          if (data.code == 201) {
            ...
            wx.login({
              success:function(raa){
                newCode=raa.code;
                wx.request({
                  url: domain.basePath + domain.InterfaceUrl.loginurl,
                  data: {
                    loginName: wx.getStorageSync('loginInfo').loginName,
                    ...
                    if (res.data.code == 200) {
                      ...
                      wx.removeStorage({
                        ...
                        success: function (ress) {
                          let str = Object.assign(res.data.data, userPh);
                          wx.setStorage({
                            key: 'userInfo',
                            data: str,
                          })
